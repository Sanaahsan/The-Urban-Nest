...
const Navbar=()=>{
    // to show/hide mobile menu when clicked
    const [showMobileMenu, setshowMobileMenu]=useState(false)
    // to prevent the webpage from scrolling
    ...
    return(
        ...
        <div className="container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent">
            <img src={assets.newLogo} 
            className="  h-30 w-auto object-contain filter invert brightness-0 contrast-200"/>
                ...
                <button className="hidden md:block bg-[#f8f9fa] text-[#0d1b2a] px-8 py-2 rounded-full">Sign up</button>
